...
![](exnswsb.png){width=600px height=450px}
...
```ansi
1206-element Vector{Tuple{Float64, Float64}}:
...
![](cfgdfdg.png){width=600px height=450px}
...
```ansi
SDMdata object with [0m[1m1190[22m presence points and [0m[1m500[22m absence points. 
...
├──────────┼──────────┼──────────┤
│   maxnet │ 0.996539 │ 0.992899 │
│      brt │ 0.999984 │ 0.999112 │
│      glm │ 0.989658 │ 0.992011 │
│ ensemble │ 0.999778 │ 0.997338 │
└──────────┴──────────┴──────────┘
test
┌──────────┬──────────┬──────────┐
│[1m    model [0m│[1m      auc [0m│[1m accuracy [0m│
│[90m      Any [0m│[90m  Float64 [0m│[90m  Float64 [0m│
├──────────┼──────────┼──────────┤
│   maxnet │ 0.995705 │ 0.992897 │
│      brt │ 0.993438 │ 0.992306 │
│      glm │ 0.989074 │ 0.992305 │
│ ensemble │ 0.995574 │ 0.992897 │
└──────────┴──────────┴──────────┘
...
![](abgxcko.png){width=600px height=450px}
...
```ansi
(bio1 = 0.28888226364759984,
 bio12 = 0.09743651877277155,)
```
...
![](kbczrsd.png){width=600px height=450px}
