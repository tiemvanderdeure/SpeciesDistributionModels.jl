...
![](mqpddot.png){width=600px height=450px}
...
```ansi
1292-element Vector{Tuple{Float64, Float64}}:
 (145.98298, -38.33349)
...
![](uessvyl.png){width=600px height=450px}
...
```ansi
SDMdata object with [0m[1m1277[22m presence points and [0m[1m500[22m absence points. 
...
├──────────┼──────────┼──────────┤
│   maxnet │ 0.996127 │ 0.990433 │
│      brt │ 0.999919 │ 0.997749 │
│      glm │ 0.989739 │ 0.990433 │
│ ensemble │ 0.998407 │ 0.995779 │
└──────────┴──────────┴──────────┘
test
┌──────────┬──────────┬──────────┐
│[1m    model [0m│[1m      auc [0m│[1m accuracy [0m│
│[90m      Any [0m│[90m  Float64 [0m│[90m  Float64 [0m│
├──────────┼──────────┼──────────┤
│   maxnet │  0.99603 │ 0.990434 │
│      brt │ 0.995345 │ 0.989309 │
│      glm │ 0.989427 │ 0.990997 │
│ ensemble │ 0.995813 │ 0.989872 │
└──────────┴──────────┴──────────┘
...
![](rbjxbic.png){width=600px height=450px}
...
```ansi
(bio1 = 0.29638237618488916,
 bio12 = 0.07922303417522457,)
```
