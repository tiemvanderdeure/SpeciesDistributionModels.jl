...
This package allows you to fit, evaluate, and project ensemble SDMs with just a few commands. It relies on [Rasters.jl](https://github.com/rafaqz/Rasters.jl/) and the [MLJ](https://github.com/juliaai/mlj.jl) ecosystem, bringing together Julia's geospatial and machine learning ecosystems. It also uses DimensionalData.jl for core results, with fitted ensembles represented as `AbstractDimArray` objects and evaluation/explanation outputs represented as `AbstractDimStack` objects.
