...
![](spkcjtg.png){width=600px height=450px}
...
![](olwkqrb.png){width=600px height=450px}
...
```ansi
SDMdata object with [0m[1m1223[22m presence points and [0m[1m500[22m absence points. 
...
├──────────┼──────────┼──────────┤
│   maxnet │ 0.997444 │ 0.992165 │
│      brt │ 0.999976 │ 0.998259 │
│      glm │ 0.997132 │ 0.993035 │
│ ensemble │ 0.999869 │ 0.996517 │
└──────────┴──────────┴──────────┘
test
┌──────────┬──────────┬──────────┐
│[1m    model [0m│[1m      auc [0m│[1m accuracy [0m│
│[90m      Any [0m│[90m  Float64 [0m│[90m  Float64 [0m│
├──────────┼──────────┼──────────┤
│   maxnet │   0.9974 │ 0.993034 │
│      brt │ 0.998284 │ 0.991292 │
│      glm │ 0.996899 │ 0.993034 │
│ ensemble │ 0.997974 │ 0.992454 │
└──────────┴──────────┴──────────┘
...
![](locujba.png){width=600px height=450px}
...
```ansi
(bio1 = 0.2788131185200815,
 bio12 = 0.10805645824962119,)
```
